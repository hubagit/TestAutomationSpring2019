package com.cybertek.tests.day7_july3;
...
public class DropDownsPractice {
    ...
    public static void test1(){
        ...
        //getFirstSelectedOption() return web element, use getText() method if
        //you want to get a text of this option, Usually, text is a visible part of
